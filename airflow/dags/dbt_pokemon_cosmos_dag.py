...
DBT_ENV = {
    ...
    "DBT_RAW_POKEMON_SCHEMA": Variable.get("pokemon_schema", default_var="raw_pokemon"),
}
...
render_config = RenderConfig(select=["tag:pokemon"])


dbt_pokemon_cosmos_dag = DbtDag(
    dag_id="dbt_pokemon_cosmos_dag",
    schedule=[POKEMON_RAW_READY],
    start_date=datetime(2024, 1, 1),
    catchup=False,
    tags=["dbt", "pokemon", "cosmos"],
